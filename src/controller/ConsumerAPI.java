...
public class ConsumerAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = consumerObj.insertConsumer(request.getParameter("name"), 
				 request.getParameter("address"), 
				request.getParameter("mobnum"), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = consumerObj.deleteConsumer(paras.get("conID").toString()); 
		response.getWriter().write(output); 
